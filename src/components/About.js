  ...
  render() {
    return (
      <div className='about'>
        ...
        <p>Comic-Con is a world wide sensation that only comes around once a year!
        To help combat the long lines we want to create an experience where fans
        can indulge in their favorite comics all year long.</p>

        <h3>Why a website?</h3>
        <p>At Comic-Con, as we are an organization by the people, for the people, we
        ...
        your creative genious.</p>

        <h3>What is this website?</h3>
        <p>This website is a place for our fans to have their own take on what
        ...
        The more support you get the more chance you have to get the exhibit built!</p>

        <h3>How to create and support?</h3>
        <p>In order to create or support an exhibit idea you must be a Comic-Con Museum member.
